...
/**
 * Created by rbh on 02.08.2015.
 */
public class CarpentersSlope extends TFCBlockCoverable {
    ...
    public CarpentersSlope(Material material)
    {
        super(material);
    }
    ...
    {
        return CarpentersBlocksHandler.SlopeRendrerID;
    }
